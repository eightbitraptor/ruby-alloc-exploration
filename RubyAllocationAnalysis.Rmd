...
all_allocations <- read_csv(params$datafile)
...
**Data collected from: `r params$datafile`**
...
## most allocations that are constant size
...
kable(constant_size_allocations)
```
